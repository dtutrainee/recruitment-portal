class SourcingpartnersController < ApplicationController
  ...
  def index
    @sourcingpartners = Sourcingpartner.all
  ...
  def create
    ...
    respond_to do |format|
      if @sourcingpartner.save
        format.html { redirect_to @sourcingpartner, notice: 'Sourcingpartner was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @sourcingpartner.update_attributes(params[:sourcingpartner])
        format.html { redirect_to @sourcingpartner, notice: 'Sourcingpartner was successfully updated.' }
